...
public class MessagesApiTest {
    ...
    public void listMessagesTest() throws ApiException {
        ...
        Region region = null;
        MessagesList response = api.listMessages(accountId, messageId, sourceTn, destinationTn, messageStatus, messageDirection, carrierName, messageType, errorCode, fromDateTime, toDateTime, campaignId, sort, pageToken, limit, limitTotalCount, region);
        // TODO: test validations
    }
