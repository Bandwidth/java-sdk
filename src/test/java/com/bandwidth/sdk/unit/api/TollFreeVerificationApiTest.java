...
public class TollFreeVerificationApiTest {
        ...
        public void listWebhookSubscriptionsTest() throws ApiException {
                ApiResponse<WebhookSubscriptionsListBody> response = api
                                .listWebhookSubscriptionsWithHttpInfo(BW_ACCOUNT_ID);
                ...
                assertThat(response.getData().getData().get(0).getType(),
        ...
        public void requestTollFreeVerificationTest() throws ApiException {
                ...
                ApiResponse<Void> response = api.requestTollFreeVerificationWithHttpInfo(BW_ACCOUNT_ID,
                                verificationRequest);
        ...
        public void updateTollFreeVerificationRequestTest() throws ApiException {
                TfvSubmissionWrapper tfvSubmissionWrapper = new TfvSubmissionWrapper()
                                .submission(null);
                ApiResponse<Void> response = api.updateTollFreeVerificationRequestWithHttpInfo(BW_ACCOUNT_ID,
                                "+18005551234",
