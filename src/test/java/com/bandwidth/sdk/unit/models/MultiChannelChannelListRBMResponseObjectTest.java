...
/**
 * Model tests for MultiChannelChannelListRBMResponseObject
 */
public class MultiChannelChannelListRBMResponseObjectTest {
    private final MultiChannelChannelListRBMResponseObject model = new MultiChannelChannelListRBMResponseObject()
            .from("+1234567890")
     ...
     */
    @Test
    public void testMultiChannelChannelListRBMResponseObject() {
        assertThat(model, instanceOf(MultiChannelChannelListRBMResponseObject.class));
    }
