 ...
 */
public class IrisBasicAuthManager implements AuthManager, IrisBasicAuthCredentials {
     ...
     */
    public IrisBasicAuthManager(String username, String password) {
    ...
    /**
     * Converts this IrisBasicAuthManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "IrisBasicAuthManager [" + "basicAuthUserName=" + basicAuthUserName
