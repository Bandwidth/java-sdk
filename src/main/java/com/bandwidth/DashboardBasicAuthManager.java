 ...
 */
public class DashboardBasicAuthManager implements AuthManager, DashboardBasicAuthCredentials {
     ...
     */
    public DashboardBasicAuthManager(String username, String password) {
    ...
    /**
     * Converts this DashboardBasicAuthManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DashboardBasicAuthManager [" + "basicAuthUserName=" + basicAuthUserName
