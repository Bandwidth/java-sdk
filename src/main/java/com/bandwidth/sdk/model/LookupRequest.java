...
public class LookupRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("tns"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("tns"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LookupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LookupRequest is not found in the empty JSON string", LookupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("tns") == null) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `tns` to be an array in the JSON string but got `%s`", jsonObj.get("tns").toString()));
      }
  }
