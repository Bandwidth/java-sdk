...
public class TransferDisconnectCallback {
   ...
   * @return the TransferDisconnectCallback instance itself
   */
  public TransferDisconnectCallback putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransferDisconnectCallback transferDisconnectCallback = (TransferDisconnectCallback) o;
    return Objects.equals(this.eventType, transferDisconnectCallback.eventType) &&
        Objects.equals(this.eventTime, transferDisconnectCallback.eventTime) &&
        Objects.equals(this.accountId, transferDisconnectCallback.accountId) &&
        Objects.equals(this.applicationId, transferDisconnectCallback.applicationId) &&
        Objects.equals(this.from, transferDisconnectCallback.from) &&
        Objects.equals(this.to, transferDisconnectCallback.to) &&
        Objects.equals(this.direction, transferDisconnectCallback.direction) &&
        Objects.equals(this.callId, transferDisconnectCallback.callId) &&
        Objects.equals(this.callUrl, transferDisconnectCallback.callUrl) &&
        Objects.equals(this.parentCallId, transferDisconnectCallback.parentCallId) &&
        Objects.equals(this.enqueuedTime, transferDisconnectCallback.enqueuedTime) &&
        Objects.equals(this.startTime, transferDisconnectCallback.startTime) &&
        Objects.equals(this.answerTime, transferDisconnectCallback.answerTime) &&
        Objects.equals(this.endTime, transferDisconnectCallback.endTime) &&
        Objects.equals(this.tag, transferDisconnectCallback.tag) &&
        Objects.equals(this.transferCallerId, transferDisconnectCallback.transferCallerId) &&
        Objects.equals(this.transferTo, transferDisconnectCallback.transferTo) &&
        Objects.equals(this.cause, transferDisconnectCallback.cause) &&
        Objects.equals(this.errorMessage, transferDisconnectCallback.errorMessage) &&
        Objects.equals(this.errorId, transferDisconnectCallback.errorId)&&
        Objects.equals(this.additionalProperties, transferDisconnectCallback.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventType, eventTime, accountId, applicationId, from, to, direction, callId, callUrl, parentCallId, enqueuedTime, startTime, answerTime, endTime, tag, transferCallerId, transferTo, cause, errorMessage, errorId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eventType", "eventTime", "accountId", "applicationId", "from", "to", "direction", "callId", "callUrl", "parentCallId", "enqueuedTime", "startTime", "answerTime", "endTime", "tag", "transferCallerId", "transferTo", "cause", "errorMessage", "errorId"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransferDisconnectCallback
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferDisconnectCallback.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TransferDisconnectCallback is not found in the empty JSON string", TransferDisconnectCallback.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("errorId") != null && !jsonObj.get("errorId").isJsonNull()) && !jsonObj.get("errorId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `errorId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("errorId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransferDisconnectCallback.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransferDisconnectCallback' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransferDisconnectCallback> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransferDisconnectCallback.class));

       return (TypeAdapter<T>) new TypeAdapter<TransferDisconnectCallback>() {
           @Override
           public void write(JsonWriter out, TransferDisconnectCallback value) throws IOException {
           ...
           @Override
           public TransferDisconnectCallback read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TransferDisconnectCallback instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of TransferDisconnectCallback
   * @throws IOException if the JSON string is invalid with respect to TransferDisconnectCallback
   */
  public static TransferDisconnectCallback fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransferDisconnectCallback.class);
  }
