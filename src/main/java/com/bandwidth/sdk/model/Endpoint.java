...
public class Endpoint {
  ...
  public Endpoint devices(@javax.annotation.Nullable List<Device> devices) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("endpointId", "type", "status", "creationTimestamp", "expirationTimestamp", "tag", "devices"));
