...
public class CreateMessageRequestError {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "description", "fieldErrors"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMessageRequestError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CreateMessageRequestError is not found in the empty JSON string", CreateMessageRequestError.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("fieldErrors") != null && !jsonObj.get("fieldErrors").isJsonNull()) {
        ...
        if (jsonArrayfieldErrors != null) {
          ...
          if (!jsonObj.get("fieldErrors").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `fieldErrors` to be an array in the JSON string but got `%s`", jsonObj.get("fieldErrors").toString()));
          }
