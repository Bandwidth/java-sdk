...
public class EndpointResponse {
  ...
  public EndpointResponse links(@javax.annotation.Nonnull List<BrtcLink> links) {
    this.links = links;
    return this;
  }
  ...
  public EndpointResponse errors(@javax.annotation.Nonnull List<BrtcError> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EndpointResponse is not found in the empty JSON string", EndpointResponse.openapiRequiredFields.toString()));
        }
      }
