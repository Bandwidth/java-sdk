...
public class AccountStatistics {
   ...
   * @return the AccountStatistics instance itself
   */
  public AccountStatistics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentCallQueueSize, accountStatistics.currentCallQueueSize) &&
        ...
        Objects.equals(this.additionalProperties, accountStatistics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentCallQueueSize, maxCallQueueSize, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("currentCallQueueSize", "maxCallQueueSize"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountStatistics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccountStatistics is not found in the empty JSON string", AccountStatistics.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AccountStatistics>() {
           ...
           public AccountStatistics read(JsonReader in) throws IOException {
             ...
             AccountStatistics instance = thisAdapter.fromJsonTree(jsonObj);
