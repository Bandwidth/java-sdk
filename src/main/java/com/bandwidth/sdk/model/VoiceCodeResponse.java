...
public class VoiceCodeResponse {
   ...
   * @return the VoiceCodeResponse instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.callId, voiceCodeResponse.callId)&&
        Objects.equals(this.additionalProperties, voiceCodeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(callId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("callId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VoiceCodeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VoiceCodeResponse is not found in the empty JSON string", VoiceCodeResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VoiceCodeResponse>() {
           ...
           public VoiceCodeResponse read(JsonReader in) throws IOException {
             ...
             VoiceCodeResponse instance = thisAdapter.fromJsonTree(jsonObj);
