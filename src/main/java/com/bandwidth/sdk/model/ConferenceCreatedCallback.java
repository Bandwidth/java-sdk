...
public class ConferenceCreatedCallback {
   ...
   * @return the ConferenceCreatedCallback instance itself
   */
  public ConferenceCreatedCallback putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventType, conferenceCreatedCallback.eventType) &&
        ...
        Objects.equals(this.additionalProperties, conferenceCreatedCallback.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConferenceCreatedCallback.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConferenceCreatedCallback is not found in the empty JSON string", ConferenceCreatedCallback.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConferenceCreatedCallback>() {
           ...
           public ConferenceCreatedCallback read(JsonReader in) throws IOException {
             ...
             ConferenceCreatedCallback instance = thisAdapter.fromJsonTree(jsonObj);
