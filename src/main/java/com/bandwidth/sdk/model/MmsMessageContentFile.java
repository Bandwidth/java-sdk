...
public class MmsMessageContentFile {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fileUrl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MmsMessageContentFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MmsMessageContentFile is not found in the empty JSON string", MmsMessageContentFile.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<MmsMessageContentFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MmsMessageContentFile.class));

       return (TypeAdapter<T>) new TypeAdapter<MmsMessageContentFile>() {
           @Override
