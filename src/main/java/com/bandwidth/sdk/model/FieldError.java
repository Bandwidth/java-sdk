...
public class FieldError {
   ...
   * @return the FieldError instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fieldName, description, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fieldName", "description"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FieldError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FieldError is not found in the empty JSON string", FieldError.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FieldError>() {
           ...
           public FieldError read(JsonReader in) throws IOException {
             ...
             FieldError instance = thisAdapter.fromJsonTree(jsonObj);
