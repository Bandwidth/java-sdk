...
public class RecordingTranscriptionMetadata {
   ...
   * @return the RecordingTranscriptionMetadata instance itself
   */
  public RecordingTranscriptionMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecordingTranscriptionMetadata recordingTranscriptionMetadata = (RecordingTranscriptionMetadata) o;
    return Objects.equals(this.id, recordingTranscriptionMetadata.id) &&
        Objects.equals(this.status, recordingTranscriptionMetadata.status) &&
        Objects.equals(this.completedTime, recordingTranscriptionMetadata.completedTime) &&
        Objects.equals(this.url, recordingTranscriptionMetadata.url)&&
        Objects.equals(this.additionalProperties, recordingTranscriptionMetadata.additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "status", "completedTime", "url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecordingTranscriptionMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RecordingTranscriptionMetadata is not found in the empty JSON string", RecordingTranscriptionMetadata.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecordingTranscriptionMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecordingTranscriptionMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecordingTranscriptionMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecordingTranscriptionMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<RecordingTranscriptionMetadata>() {
           @Override
           public void write(JsonWriter out, RecordingTranscriptionMetadata value) throws IOException {
           ...
           @Override
           public RecordingTranscriptionMetadata read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RecordingTranscriptionMetadata instance = thisAdapter.fromJsonTree(jsonObj);
