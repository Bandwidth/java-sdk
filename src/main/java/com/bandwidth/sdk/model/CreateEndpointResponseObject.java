...
public class CreateEndpointResponseObject {
  ...
  public CreateEndpointResponseObject devices(@javax.annotation.Nullable List<Device> devices) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateEndpointResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEndpointResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEndpointResponseObject>() {
           @Override
