...
public class TransferCompleteCallback {
   ...
   * @return the TransferCompleteCallback instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventType, transferCompleteCallback.eventType) &&
        ...
        Objects.equals(this.additionalProperties, transferCompleteCallback.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventType, eventTime, accountId, applicationId, from, to, direction, callId, callUrl, enqueuedTime, startTime, answerTime, tag, transferCallerId, transferTo, cause, errorMessage, errorId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eventType", "eventTime", "accountId", "applicationId", "from", "to", "direction", "callId", "callUrl", "enqueuedTime", "startTime", "answerTime", "tag", "transferCallerId", "transferTo", "cause", "errorMessage", "errorId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferCompleteCallback.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TransferCompleteCallback is not found in the empty JSON string", TransferCompleteCallback.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TransferCompleteCallback>() {
           ...
           public TransferCompleteCallback read(JsonReader in) throws IOException {
             ...
             TransferCompleteCallback instance = thisAdapter.fromJsonTree(jsonObj);
