...
public class UpdateConferenceMember {
   ...
   * @return the UpdateConferenceMember instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mute, updateConferenceMember.mute) &&
        ...
        Objects.equals(this.additionalProperties, updateConferenceMember.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mute, hold, callIdsToCoach, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mute", "hold", "callIdsToCoach"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateConferenceMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateConferenceMember is not found in the empty JSON string", UpdateConferenceMember.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateConferenceMember>() {
           ...
           public UpdateConferenceMember read(JsonReader in) throws IOException {
             ...
             UpdateConferenceMember instance = thisAdapter.fromJsonTree(jsonObj);
