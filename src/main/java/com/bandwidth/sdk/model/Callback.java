                    ...
                    if (jsonObject.get("type") == null) {
                        ...
                        switch (jsonObject.get("type").getAsString()) {
                            ...
                            case "statusCallback":
                                ...
                                return newCallback;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for Callback. Possible values: message-delivered message-failed message-read message-received message-sent request-location-response suggestion-response inboundCallback statusCallback", jsonObject.get("type").getAsString()));
                        }
                    }
