...
public final class APIController extends BaseController {
    ...
    public ApiResponse<Void> uploadMedia(
        ...
        HttpRequest request = buildUploadMediaRequest(accountId, mediaId, contentLength, body,
    ...
    public CompletableFuture<ApiResponse<Void>> uploadMediaAsync(
        ...
        return makeHttpCallAsync(() -> buildUploadMediaRequest(accountId, mediaId, contentLength,
                body, contentType, cacheControl),
            req -> authManagers.get("messaging").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsStringAsync(request)),
