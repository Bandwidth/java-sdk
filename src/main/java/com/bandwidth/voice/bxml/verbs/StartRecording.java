...
/**
 * The StartRecording verb allows a segment of a call to be recorded while other
 * verbs are executing.
 * <br/>
 * All audio on both sides of the call will be recorded until the call ends or
 * the <StopRecording> verb is used or the <PauseRecording> verb is used.
 */
@Builder
...
public class StartRecording implements Verb {
    ...
    /**
     * <i>(optional)</i> A boolean value indicating whether or not the recording
     * file should separate each side of the call into its own audio channel.
     * Default value is false. true results in two channels.
     */
    @XmlAttribute
