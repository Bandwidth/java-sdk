...
public final class APIController extends BaseController {
     ...
     */
    private ApiResponse<AccountsParticipantsResponse> handleCreateParticipantResponse(
    ...
    private HttpRequest buildGetParticipantRequest(
        ...
        templateParameters.put("participantId",
                new SimpleEntry<Object, Boolean>(participantId, false));
        ApiHelper.appendUrlWithTemplateParameters(queryBuilder, templateParameters);
     ...
     */
    private ApiResponse<Participant> handleGetParticipantResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     */
    private ApiResponse<Void> handleDeleteParticipantResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     */
    private ApiResponse<Session> handleCreateSessionResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
    ...
    private HttpRequest buildGetSessionRequest(
        ...
        templateParameters.put("sessionId",
                new SimpleEntry<Object, Boolean>(sessionId, false));
        ApiHelper.appendUrlWithTemplateParameters(queryBuilder, templateParameters);
     ...
     * @return An object of type Session
     */
    private ApiResponse<Session> handleGetSessionResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     * @return An object of type void
     */
    private ApiResponse<Void> handleDeleteSessionResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     */
    private ApiResponse<List<Participant>> handleListSessionParticipantsResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     * @return An object of type void
     */
    private ApiResponse<Void> handleAddParticipantToSessionResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
    ...
    public ApiResponse<Void> removeParticipantFromSession(
            ...
            final String participantId,
            final String sessionId) throws ApiException, IOException {
        HttpRequest request = buildRemoveParticipantFromSessionRequest(accountId, participantId,
                sessionId);
        authManagers.get("webRtc").apply(request);
     ...
     * @return An object of type void
     */
    private ApiResponse<Void> handleRemoveParticipantFromSessionResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
    ...
    public ApiResponse<Subscriptions> getParticipantSubscriptions(
            ...
            final String participantId,
            final String sessionId) throws ApiException, IOException {
        HttpRequest request = buildGetParticipantSubscriptionsRequest(accountId, participantId,
                sessionId);
        authManagers.get("webRtc").apply(request);
    ...
    public CompletableFuture<ApiResponse<Subscriptions>> getParticipantSubscriptionsAsync(
            ...
            final String participantId,
            final String sessionId) {
        return makeHttpCallAsync(() -> buildGetParticipantSubscriptionsRequest(accountId,
                participantId, sessionId),
            req -> authManagers.get("webRtc").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsStringAsync(request)),
     ...
     */
    private ApiResponse<Subscriptions> handleGetParticipantSubscriptionsResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
    ...
    public ApiResponse<Void> updateParticipantSubscriptions(
            ...
            final String sessionId,
            final Subscriptions body) throws ApiException, IOException {
        HttpRequest request = buildUpdateParticipantSubscriptionsRequest(accountId, participantId,
                sessionId, body);
        authManagers.get("webRtc").apply(request);
     ...
     * @return An object of type void
     */
    private ApiResponse<Void> handleUpdateParticipantSubscriptionsResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
