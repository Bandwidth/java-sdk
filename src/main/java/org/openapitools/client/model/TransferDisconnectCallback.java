...
public class TransferDisconnectCallback {
  ...
  **/
  ...
  public TransferDisconnectCallback eventTime(String eventTime) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventType, eventTime, accountId, applicationId, from, to, direction, callId, callUrl, parentCallId, enqueuedTime, startTime, answerTime, endTime, tag, transferCallerId, transferTo, cause, errorMessage, errorId);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransferDisconnectCallback
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransferDisconnectCallback.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransferDisconnectCallback.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransferDisconnectCallback` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
